...
class DJEPA(nn.Module):
    ...
    def __init__(self, img_size=256, vae_stride=16, patch_size=1,
        ...
        # --------------------------------------------------------------------------
        # DJEPA variant masking ratio, a left-half truncated Gaussian centered at 100% masking ratio with std 0.25
        ...
        # --------------------------------------------------------------------------
        # DJEPA encoder specifics (used for classification and diffusion.)
        ...
        # --------------------------------------------------------------------------
        # DJEPA decoder specifics (no requires for classification task.)
